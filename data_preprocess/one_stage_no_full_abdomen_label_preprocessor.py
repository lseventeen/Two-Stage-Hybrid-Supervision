...
class One_stage_no_full_abdomen_label_preprocessor(First_stage_not_full_abdomen_label_preprocessor):
    ...
    def run_case_npy(self, data: np.ndarray, seg: Union[np.ndarray, None], pre, properties: dict):
        ...
        if self.verbose:
            ...
            print(f'old shape: {old_shape}, new_shape: {self.new_shape},'
...
def run_preprocess_entry():
    ...
    pp = One_stage_no_full_abdomen_label_preprocessor(new_shape = CFG['Dataloader']['data_size'],
